<div class="category-slide d-flex ">
<!---->
    ...
    <div class="slide d-none d-md-block col-md-8" >
            ...
            <div class="d-flex flex-row" >
                <div style="width:20% !important; "><img src="views/img/ads2.jpg" class="w-100" style="width:; height:400px;"></div>
                <div style="width:80% !important; " style="background-color:;">
                    <div class=" w-100" style="background-color:;">
                        <img src="views/img/ads1.png" class="w-100 p-3" style=" height:200px;"/>
                    </div>
                    <div class="d-flex flex-row container-fluid  justify-content-between w-100">
                    <div class="ChakraPetch text-center text-success" ><img src="views/img/product1.jpg" class="p-3"  style="width:150px; height:200px;" /> <br> 30MAD </div>
                    <div class="ChakraPetch text-center text-success"><img src="views/img/product3.jpg" class="p-3"  style="width:150px; height:200px;" /> <br> 30MAD</div>
                    <div class="ChakraPetch text-center text-success"><img src="views/img/product2.jpg" class="p-3"  style="width:150px; height:200px;" /> <br> 30MAD</div>
